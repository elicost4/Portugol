programa
{
	...
	real indice
        ...
        se (indice>=0.3 e indice<0.4)
        {
            ...
            escreva ("Indice de poluentes esta em " ,indice, "\n Empresas do 1º grupo, suspendam suas atividades!")
        }
        senao se (indice>=0.4 e indice<0.5)
        {
            escreva ("Indice de poluentes esta em ",indice, "\n Empresas do 1º grupo e 2º grupo, suspendam suas atividades!")
        }
        senao se (indice>=0.5)
        {
            escreva ("Indice de poluentes esta em ",indice, "\n Todas as empresas suspendam suas atividades!")
        }
        senao 
        {
            escreva ("Indice de poluentes esta instavel siga com os trabalhos!")
        }
    }
    //fim
}
